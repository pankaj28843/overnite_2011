...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '/media/images/nicEditorIcons.gif	',
...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		this.panelContain = new bkElement('DIV').setStyle({clear:'both', overflow : 'hidden', width : '100%', border : '1px solid #cccccc', backgroundColor : '#efefef'}).addClass('panelContain');
...
var nicImageButton = nicEditorAdvancedButton.extend({	
	...
	submit : function(e) {
		...
		if(this.im) {
		    this.im.setStyle({'maxWidth' : max_image_width});
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	...
	addForm : function() {
		...
		myDoc.open();
		myDoc.write("<html><body><img src=\"http://files.nicedit.com/ajax-loader.gif\" style=\"display:none;\" />");
	...
	startUpload : function() {
		...
		this.myStatus.setContent('<img src="http://files.nicedit.com/ajax-loader.gif" style="width:32px; height:32px; float:right; margin-right: 40px;" alt = " " /><strong>Uploading...</strong><br />Please wait');
		this.myForm.submit();
