...
def home(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for in_out in problem.testcase_set.all():
            ...
            new_submission.celery_task = submit.apply_async(args = [new_submission.problem, new_submission.language, new_submission.program.read(),tests])
            new_submission.save()
